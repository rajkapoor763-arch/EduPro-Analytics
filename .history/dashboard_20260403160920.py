...
@st.cache_data
def load_data():
    teachers     = pd.read_csv("EDUPro_project\EduPro Online Platform.xlsx - Teachers.csv")
    courses      = pd.read_csv("EDUPro_project\EduPro Online Platform.xlsx - Courses.csv")
    transactions = pd.read_csv("EDUPro_project\EduPro Online Platform.xlsx - Transactions.csv")
