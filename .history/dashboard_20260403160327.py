...
@st.cache_data
def load_data():
    teachers     = pd.read_csv("EduPro_Online_Platform_xlsx-Teachers.csv")
    courses      = pd.read_csv("EduPro_Online_Platform_xlsx-Courses.csv")
    transactions = pd.read_csv("EduPro_Online_Platform_xlsx-Transactions.csv")
