...
with k1:
    ...
    <div style="background: linear-gradient(135deg, #1e3a5f, #2563eb);
        ...
        border: 1px solid #2e3a50;">
        <h2 style="color: #4f9eff; margin: 0;">3.12 ⭐</h2>
        <p style="color: #93c5fd; margin: 5px 0 0 0;">Avg Teacher Rating</p>
    </div>
    """, unsafe_allow_html=True)

with k2:
    st.markdown("""
    <div style="background: linear-gradient(135deg, #1a3a2a, #16a34a);
        padding: 20px; border-radius: 12px; text-align: center;
        border: 1px solid #2e3a50;">
        <h2 style="color: #4ade80; margin: 0;">3.10 ⭐</h2>
        <p style="color: #86efac; margin: 5px 0 0 0;">Avg Course Rating</p>
    </div>
    """, unsafe_allow_html=True)

with k3:
    st.markdown("""
    <div style="background: linear-gradient(135deg, #3a1a2a, #9333ea);
        padding: 20px; border-radius: 12px; text-align: center;
        border: 1px solid #2e3a50;">
        <h2 style="color: #c084fc; margin: 0;">10,000</h2>
        <p style="color: #d8b4fe; margin: 5px 0 0 0;">Total Enrollments</p>
    </div>
    """, unsafe_allow_html=True)

with k4:
    st.markdown("""
    <div style="background: linear-gradient(135deg, #3a2a1a, #ea580c);
        padding: 20px; border-radius: 12px; text-align: center;
        border: 1px solid #2e3a50;">
        <h2 style="color: #fb923c; margin: 0;">60</h2>
        <p style="color: #fdba74; margin: 5px 0 0 0;">Total Teachers</p>
    </div>
    """, unsafe_allow_html=True)
...
fig1.update_layout(plot_bgcolor='#1a2035',
...
fig2.update_layout(plot_bgcolor='#1a2035',
    paper_bgcolor='#1a2035',
    font_color='#e2e8f0',
    xaxis=dict(gridcolor='#2e3a50'),
    yaxis=dict(gridcolor='#2e3a50'))
...
fig3.update_layout(plot_bgcolor='#1a2035',
    paper_bgcolor='#1a2035',
    font_color='#e2e8f0',
    xaxis=dict(gridcolor='#2e3a50'),
    yaxis=dict(gridcolor='#2e3a50'))
...
fig4.update_layout(plot_bgcolor='#1a2035',
    paper_bgcolor='#1a2035',
    font_color='#e2e8f0',
    xaxis=dict(gridcolor='#2e3a50'),
    yaxis=dict(gridcolor='#2e3a50'))
...
fig5.update_layout(plot_bgcolor='#1a2035',
    paper_bgcolor='#1a2035',
    font_color='#e2e8f0',
    xaxis=dict(gridcolor='#2e3a50'),
    yaxis=dict(gridcolor='#2e3a50'))
...
fig6.update_layout(plot_bgcolor='#1a2035',
    paper_bgcolor='#1a2035',
    font_color='#e2e8f0',
    xaxis=dict(gridcolor='#2e3a50'),
    yaxis=dict(gridcolor='#2e3a50'))
